...
import { z } from "zod";
import { CLUE_MODEL, CLUE_SYSTEM_PROMPT, friendlyAiError, getClientIp, groq, rateLimit } from "@/lib/groq";
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const msg = friendlyAiError(err, "The clues would not come. Try again.");
